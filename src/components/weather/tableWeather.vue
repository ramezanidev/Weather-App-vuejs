...
.thead {
  width: 100%;
  box-shadow: 0 20px 18px -17px rgb(0 0 0 / 32%);
  height: 50px;
  display: flex;
  justify-content: space-between;
  align-items: center;
  border-bottom: 1px solid hsla(0, 0%, 81.2%, 0.8666666666666667);
  color: #fff;
  font-family: Vazir;
  line-height: 18px;
  font-size: 17px;
...
.tbody {
  ...
  scrollbar-color: #06f hsla(0, 0%, 100%, 0);
